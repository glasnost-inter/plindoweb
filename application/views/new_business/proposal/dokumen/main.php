                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
					  ...
					  ?>
                                    ...
                                    <td><a href="<?php echo base_url('index.php/cproposal/daftar_dokumen_proposal/'.$data->NO_PROPOSAL) ?>" class="btn btn-primary btn-sm">Dokumen&nbsp;&nbsp;<i class="fa fa-pencil-square-o"></i></a>                                        
                                    </td>
                                </tr>
                                                    <?php
                                                    }    
